...
struct CalarmWidgetExtensionEntryView: View {
...
struct CalarmWidgetExtension: Widget {
    let kind: String = "CalarmWidgetExtension"

    var body: some WidgetConfiguration {
        AppIntentConfiguration(kind: kind, intent: ConfigurationAppIntent.self, provider: Provider()) { entry in
            CalarmWidgetExtensionEntryView(entry: entry)
